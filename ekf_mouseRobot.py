...
def mouseCallback(event, x, y, flags, mouse_info):
    ...
    # t = (now * 1000 - mouse_info.last_time)
    # mouse_info.x = mouse_info.x + mouse_info.v_x * t
    # mouse_info.y = mouse_info.y + mouse_info.v_y * t
    # mouse_info.last_time = now * 1000

    mouse_info.last_x = mouse_info.x
    mouse_info.last_y = mouse_info.y
